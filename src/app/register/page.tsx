      ...
      <div className="dark:bg-gray-800 w-1/2 m-auto flex shadow-lg">
        ...
        <div className='w-1/2'>
          ...
          <div className='flex flex-col'>
            ...
            <input type="text" name="firstName" className='border border-black dark:border-gray-500 dark:focus:shadow-lg focus:shadow-gray-900 caret-rose-600 m-2' />
            <span className='mx-2 '>Last Name</span>
            <input type="text" name="lastName" className='border border-black dark:border-gray-500 dark:focus:shadow-lg focus:shadow-gray-900 caret-rose-600 m-2' />
            ...
            <input type="password" name="confirmPassword" className='border border-black dark:border-gray-500 dark:focus:shadow-lg focus:shadow-gray-900 caret-rose-600 m-2' />
